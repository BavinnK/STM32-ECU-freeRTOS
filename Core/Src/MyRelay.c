...
void relay_init(void) {
	...
	GPIOB->MODER &= ~((1 << 21) | (1 << 20) | (1 << 11) | (1 << 10) | (1 << 9)
			| (1 << 8));
...
void relay_set_fan_speed(FanSpeed_t speed) {
	...
	case FAN_SPEED_OFF:	//all is LOW
		GPIOB->BSRR = (1 << 26) | (1 << 21) | (1 << 20);
		break;
	case FAN_SPEED_LOW:	//PB10 HIGH ,PB5 LOW ,PB4 LOW
		GPIOB->BSRR = (1 << 10);
		GPIOB->BSRR = (1 << 21) | (1 << 20);
		break;
	case FAN_SPEED_MEDIUM:	//BP5 HIGH, PB10 LOW, PB4 LOW
		GPIOB->BSRR = (1 << 5);
